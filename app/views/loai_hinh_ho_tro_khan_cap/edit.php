<?php
// View: app/views/loai_hinh_ho_tro_khan_cap/edit.php
...
<form action="<?php echo url('loai-hinh-ho-tro-khan-cap/update/' . $loaiHinh['id']); ?>" method="POST" class="bg-white p-6 rounded-lg shadow-md">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
            ...
            <div class="mb-4">
                ...
                <input type="number" id="gia_tri_ho_tro_dinh_muc" name="gia_tri_ho_tro_dinh_muc" min="0" step="1000"
                       value="<?php echo htmlspecialchars($displayData['gia_tri_ho_tro_dinh_muc'] ?? '', ENT_QUOTES, 'UTF-8'); ?>"
            ...
            <div class="mb-4">
                ...
                <input type="text" id="don_vi_tinh_gt" name="don_vi_tinh_gt" maxlength="50"
                       value="<?php echo htmlspecialchars($displayData['don_vi_tinh_gt'] ?? 'VNĐ', ENT_QUOTES, 'UTF-8'); ?>"
                       class="form-input">
            </div>
        </div>
        ...
        <div>
             <div class="mb-4">
                ...
                <textarea id="mo_ta_hien_vat_dinh_muc" name="mo_ta_hien_vat_dinh_muc" rows="2" class="form-textarea"><?php echo htmlspecialchars($displayData['mo_ta_hien_vat_dinh_muc'] ?? '', ENT_QUOTES, 'UTF-8'); ?></textarea>
            </div>
            <div class="mb-4">
                <label for="mo_ta" class="form-label">Mô tả chi tiết loại hình</label>
                <textarea id="mo_ta" name="mo_ta" rows="2" class="form-textarea"><?php echo htmlspecialchars($displayData['mo_ta'] ?? '', ENT_QUOTES, 'UTF-8'); ?></textarea>
            </div>
    ...
    <div class="mt-6 pt-4 border-t border-gray-200 flex justify-end space-x-3">
        <a href="<?php echo url('loai-hinh-ho-tro-khan-cap/index'); ?>" class="btn bg-gray-200 text-gray-700 hover:bg-gray-300">Quay lại DS</a>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    calculateGiaTriHoTro(); // Calculate on page load
});
</script>