<?php
// View: app/views/loai_hinh_ho_tro_khan_cap/index.php
...
<div class="mb-6 flex justify-between items-center">
    ...
    <a href="<?php echo url('loai-hinh-ho-tro-khan-cap/create'); ?>" class="btn btn-primary">
...
<div class="mb-4 bg-white p-4 rounded-lg shadow-sm">
    <form action="" method="GET" class="grid grid-cols-1 md:grid-cols-3 gap-4 items-end">
        ...
        <input type="hidden" name="url" value="loai-hinh-ho-tro-khan-cap/index">
        ...
        <div class="flex space-x-2">
            ...
            <?php if (!empty($currentFilters['searchTerm']) || !empty($currentFilters['trang_thai_ap_dung'])): ?>
                <a href="<?php echo url('loai-hinh-ho-tro-khan-cap/index'); ?>" class="btn bg-gray-300 hover:bg-gray-400 text-gray-700 flex-grow">Xóa lọc</a>
            <?php endif; ?>
        </div>
    </form>
</div>
    ...
    <table class="table">
        ...
        <tbody class="divide-y divide-gray-200">
            <?php if (empty($loaiHinhList)): ?>
                <tr>
                    <td colspan="10" class="text-center py-4 text-gray-500">Không tìm thấy loại hình nào.</td>
                </tr>
            <?php else: ?>
                ...
                <?php foreach ($loaiHinhList as $lh): ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo url('loai-hinh-ho-tro-khan-cap/edit/' . $lh['id']); ?>" class="font-medium text-blue-600 hover:underline">
                        ...
                        <td class="text-right"><?php echo isset($lh['gia_tri_ho_tro_dinh_muc']) ? number_format($lh['gia_tri_ho_tro_dinh_muc'], 0, ',', '.') : 'N/A'; ?></td>
                        <td><?php echo !empty($lh['mo_ta_hien_vat_dinh_muc']) ? htmlspecialchars(mb_strimwidth($lh['mo_ta_hien_vat_dinh_muc'], 0, 50, "..."), ENT_QUOTES, 'UTF-8') : 'Không có'; ?></td>
                        <td>
                        ...
                        <td class="text-center sticky right-0 bg-white z-10 border-l border-gray-200">
                            <div class="flex justify-center items-center space-x-1">
                                <a href="<?php echo url('loai-hinh-ho-tro-khan-cap/edit/' . $lh['id']); ?>" title="Sửa" class="text-blue-600 hover:text-blue-800 p-1">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" /></svg>
                                </a>
                                <form action="<?php echo url('loai-hinh-ho-tro-khan-cap/destroy/' . $lh['id']); ?>" method="POST" onsubmit="return confirm('Bạn có chắc chắn muốn xóa loại hình này?');" class="inline-block">
