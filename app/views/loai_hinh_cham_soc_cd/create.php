<?php
// View: app/views/loai_hinh_cham_soc_cd/create.php
?>
...
<form action="<?php echo url('loai-hinh-cham-soc-cd/store'); ?>" method="POST" class="bg-white p-6 rounded-lg shadow-md">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
            <div class="mb-4">
                <label for="ma_loai_hinh" class="form-label">Mã quản lý <span class="text-red-500">*</span></label>
            ...
            <div class="mb-4">
                <label for="ten_loai_hinh" class="form-label">Tên Loại Hình/Loại đối tượng <span class="text-red-500">*</span></label>
            ...
            <div class="mb-4">
                ...
                <input type="number" id="kinh_phi_dinh_muc_du_kien" name="kinh_phi_dinh_muc_du_kien" min="0" step="1000"
                       value="<?php echo htmlspecialchars($oldData['kinh_phi_dinh_muc_du_kien'] ?? '', ENT_QUOTES, 'UTF-8'); ?>"
            ...
            <div class="mb-4">
                ...
                <input type="text" id="don_vi_tinh_kp" name="don_vi_tinh_kp" maxlength="50"
                       value="<?php echo htmlspecialchars($oldData['don_vi_tinh_kp'] ?? 'VNĐ', ENT_QUOTES, 'UTF-8'); ?>"
                       class="form-input">
            </div>
        </div>
    ...
    <div class="mt-6 pt-4 border-t border-gray-200 flex justify-end space-x-3">
        <a href="<?php echo url('loai-hinh-cham-soc-cd/index'); ?>" class="btn bg-gray-200 text-gray-700 hover:bg-gray-300">Hủy</a>
